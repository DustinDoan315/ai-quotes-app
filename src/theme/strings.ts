...
const en = {
  ...
  profile: {
    ...
    appLanguageDescription: "Changes buttons, labels, and menus across the app.",
    quoteLanguage: "Quote language",
    quoteLanguageDescription: "Changes the language used when AI creates your quotes.",
    email: "Email",
    verified: "Verified",
...
const vi: AppStrings = {
  ...
  profile: {
    ...
    appLanguageDescription: "Thay đổi nút, nhãn và menu trong toàn bộ ứng dụng.",
    quoteLanguage: "Ngôn ngữ quote",
    quoteLanguageDescription: "Thay đổi ngôn ngữ AI dùng để tạo câu quote cho bạn.",
    email: "Email",
